...
if ! grep -q $SHORT_NAME /usr/share/X11/xkb/rules/base.lst; then
...
if ! grep -q $SHORT_NAME /usr/share/X11/xkb/rules/evdev.lst; then
...
if ! grep -q $SHORT_NAME /usr/share/X11/xkb/rules/base.xml; then
...
if ! grep -q $SHORT_NAME /usr/share/X11/xkb/rules/evdev.xml; then
