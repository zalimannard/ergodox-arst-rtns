...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    TD(DANCE_0),    KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,                                          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,         TD(DANCE_9),
    KC_TAB,         KC_LBRACKET,    TD(DANCE_1),    TD(DANCE_2),    KC_P,           TD(DANCE_3),    TD(DANCE_4),                                    KC_AUDIO_VOL_UP,KC_F,           TD(DANCE_10),   TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   KC_AUDIO_MUTE,
    TT(1),          KC_A,           TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    KC_D,                                                                           KC_H,           KC_N,           KC_E,           KC_I,           KC_O,           TT(1),
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           TD(DANCE_8),                                    KC_AUDIO_VOL_DOWN,KC_K,           KC_M,           KC_J,           KC_EQUAL,       KC_MINUS,       KC_RSHIFT,
    LALT(KC_0),     KC_LALT,        KC_LCTRL,       KC_LEFT,        KC_RIGHT,                                                                                                       KC_DOWN,        KC_UP,          KC_RCTRL,       KC_RALT,        RALT(KC_1),
                                                                                                    KC_HASH,        KC_MEDIA_PLAY_PAUSE,TD(DANCE_14),   KC_PSCREEN,
                                                                                                                    KC_INSERT,      TD(DANCE_15),
                                                                                    KC_BSPACE,      KC_DELETE,      KC_LGUI,        KC_RGUI,        KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_SCOLON,      KC_AMPR,        KC_EXLM,        KC_AT,          KC_NO,          KC_NO,                                          KC_NUMLOCK,     KC_PERC,        KC_7,           KC_8,           KC_9,           KC_KP_ASTERISK, KC_KP_SLASH,
    KC_TRANSPARENT, KC_LABK,        KC_LBRACKET,    KC_LPRN,        KC_LCBR,        KC_CIRC,                                                                        KC_MINUS,       KC_4,           KC_5,           KC_6,           KC_KP_MINUS,    KC_TRANSPARENT,
    KC_LSHIFT,      KC_RABK,        KC_RBRACKET,    KC_RPRN,        KC_RCBR,        KC_DLR,         KC_HASH,                                        KC_NO,          KC_COMMA,       KC_1,           KC_2,           KC_3,           KC_KP_PLUS,     KC_RSHIFT,
    KC_ENTER,       KC_LALT,        KC_LCTRL,       KC_CIRC,        KC_COLN,                                                                                                        KC_0,           KC_DOT,         KC_RCTRL,       KC_RALT,        KC_ENTER,
                                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,
                                                                                                                    KC_NO,          KC_NO,
                                                                                    KC_LSHIFT,      KC_LSHIFT,      KC_NO,          KC_NO,          KC_RSHIFT,      KC_RSHIFT
  ),
  [2] = LAYOUT_ergodox_pretty(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          RESET,          MAGIC_TOGGLE_NKRO,EEP_RST,        KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_UP,KC_MEDIA_STOP,  KC_BRIGHTNESS_UP,KC_SYSTEM_SLEEP,
    KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                          KC_NO,          KC_MEDIA_PREV_TRACK,KC_AUDIO_VOL_DOWN,KC_MEDIA_NEXT_TRACK,KC_BRIGHTNESS_DOWN,KC_SYSTEM_WAKE,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_AUDIO_MUTE,  KC_NO,          LED_LEVEL,      KC_NO,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          KC_MY_COMPUTER, KC_WWW_SEARCH,  KC_CALCULATOR,  KC_MAIL,        KC_WWW_REFRESH,
                                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,
                                                                                                                    KC_NO,          KC_NO,
                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO
  ),
  [3] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_DELETE,                                      KC_PSCREEN,     KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPACE,
    ...
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_GRAVE,                                       KC_QUOTE,       KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,
    KC_LCTRL,       KC_LGUI,        KC_LALT,        KC_SPACE,       KC_SPACE,                                                                                                       KC_SPACE,       KC_SPACE,       KC_RALT,        KC_RCTRL,       TO(0),
                                                                                                    KC_F6,          KC_F5,          KC_F11,         KC_F12,
                                                                                                                    KC_F4,          KC_F10,
                                                                                    KC_F1,          KC_F2,          KC_F3,          KC_F9,          KC_F8,          KC_F7
  ),
  [4] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          TD(DANCE_16),
                                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,
                                                                                                                    KC_NO,          KC_NO,
                                                                                    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO
  ),
  [5] = LAYOUT_ergodox_pretty(
    ...
    KC_TAB,         KC_MS_ACCEL2,   KC_MS_BTN4,     KC_MS_WH_UP,    KC_MS_BTN5,     KC_NO,          KC_PAUSE,                                       KC_NO,          KC_NO,          KC_NO,          KC_MS_UP,       KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_MS_ACCEL1,   KC_MS_BTN1,     KC_MS_WH_DOWN,  KC_MS_BTN2,     KC_NO,                                                                          KC_NO,          KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_NO,          KC_NO,
    KC_LSHIFT,      KC_MS_ACCEL0,   KC_MS_WH_LEFT,  KC_MS_BTN3,     KC_MS_WH_RIGHT, KC_LCTRL,       KC_LALT,                                        KC_RALT,        KC_RCTRL,       KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_RSHIFT,
    KC_PC_CUT,      KC_PC_COPY,     KC_PC_PASTE,    KC_LEFT,        KC_RIGHT,                                                                                                       KC_DOWN,        KC_UP,          KC_PC_UNDO,     KC_FIND,        TO(0),
                                                                                                    KC_NO,          KC_PGUP,        KC_HOME,        KC_NO,
                                                                                                                    KC_PGDOWN,      KC_END,
                                                                                    KC_BSPACE,      KC_DELETE,      KC_LGUI,        KC_RGUI,        KC_ENTER,       KC_SPACE
  ),
};
...
void dance_5_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case SINGLE_HOLD: register_code16(RU_SHTI); break;
...
void dance_5_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RU_SHTI); break;
...
void dance_11_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[11].step) {
        ...
        case SINGLE_HOLD: register_code16(RU_SHA); break;
...
void dance_11_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[11].step) {
        ...
        case SINGLE_HOLD: unregister_code16(RU_SHA); break;
